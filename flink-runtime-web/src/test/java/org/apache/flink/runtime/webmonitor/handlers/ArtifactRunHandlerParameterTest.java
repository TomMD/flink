...
public class ArtifactRunHandlerParameterTest
	...
	@Override
	ArtifactRunMessageParameters getUnresolvedJarMessageParameters() {
		return handler.getMessageHeaders().getUnresolvedMessageParameters();
	}

	@Override
	ArtifactRunMessageParameters getJarMessageParameters(ProgramArgsParType programArgsParType) {
		final ArtifactRunMessageParameters parameters = getUnresolvedJarMessageParameters();
	...
	@Override
	ArtifactRunMessageParameters getWrongJarMessageParameters(ProgramArgsParType programArgsParType) {
	...
	@Override
	ArtifactRunRequestBody getDefaultJarRequestBody() {
		return new ArtifactRunRequestBody();
	}

	@Override
	ArtifactRunRequestBody getJarRequestBody(ProgramArgsParType programArgsParType) {
		return new ArtifactRunRequestBody(
