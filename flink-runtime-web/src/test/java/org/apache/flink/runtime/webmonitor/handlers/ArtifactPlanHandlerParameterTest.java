...
public class ArtifactPlanHandlerParameterTest
	...
	ArtifactPlanMessageParameters getJarMessageParameters(ProgramArgsParType programArgsParType) {
		final ArtifactPlanMessageParameters parameters = getUnresolvedJarMessageParameters();
	...
	@Override
	ArtifactPlanMessageParameters getWrongJarMessageParameters(ProgramArgsParType programArgsParType) {
	...
	@Override
	ArtifactPlanRequestBody getJarRequestBody(ProgramArgsParType programArgsParType) {
		return new ArtifactPlanRequestBody(
