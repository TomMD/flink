...
public class HiveCatalogValidator extends CatalogDescriptorValidator {
	...
	public static final String CATALOG_PROPERTOES_HIVE_METASTORE_URIS =
		CATALOG_PROPERTIES + "." + HIVE_METASTORE_URIS;

	@Override
	public void validate(DescriptorProperties properties) {
		super.validate(properties);
		properties.validateValue(CATALOG_TYPE, CATALOG_TYPE_VALUE_HIVE, false);
		properties.validateString(CATALOG_PROPERTOES_HIVE_METASTORE_URIS, false, 1);
	}
}
