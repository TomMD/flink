...
public class HiveCatalogFactoryTest extends TestLogger {
	...
	public void test() {
		...
		final String metastoreUris = "thrift://test";

		final HiveCatalog expectedCatalog = new HiveCatalog(catalogName, metastoreUris);

		final CatalogDescriptor catalogDescriptor = new HiveCatalogDescriptor(metastoreUris);
