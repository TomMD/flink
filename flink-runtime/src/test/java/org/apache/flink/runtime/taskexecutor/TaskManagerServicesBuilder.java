...
public class TaskManagerServicesBuilder {
	...
	public TaskManagerServicesBuilder() {
		...
		shuffleEnvironment = mock(JobAwareShuffleEnvironment.class);
	...
	public TaskManagerServicesBuilder setShuffleEnvironment(JobAwareShuffleEnvironment<?, ?> shuffleEnvironment) {
