...
public class CheckpointCoordinatorTest extends TestLogger {
	...
	public void testTriggerAndDeclineCheckpointSimple() {
		try {
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID2, checkpointId), mock(TaskManagerLocation.class));
			...
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID1, checkpointId), mock(TaskManagerLocation.class));
			...
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID1, checkpointId), mock(TaskManagerLocation.class));
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID2, checkpointId), mock(TaskManagerLocation.class));
			assertTrue(checkpoint.isDiscarded());
	...
	public void testTriggerAndDeclineCheckpointComplex() {
		try {
			...
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID1, checkpoint1Id), mock(TaskManagerLocation.class));
			...
			// decline from the other task, nothing should happen
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID1, checkpoint1Id), mock(TaskManagerLocation.class));
			coord.receiveDeclineMessage(new DeclineCheckpoint(jid, attemptID2, checkpoint1Id), mock(TaskManagerLocation.class));
			assertTrue(checkpoint1.isDiscarded());
	...
	public void testTriggerAndConfirmSimpleCheckpoint() {
		try {
			...
			coord.receiveAcknowledgeMessage(acknowledgeCheckpoint1, mock(TaskManagerLocation.class));
			assertEquals(1, checkpoint.getNumberOfAcknowledgedTasks());
			assertEquals(1, checkpoint.getNumberOfNonAcknowledgedTasks());
			assertFalse(checkpoint.isDiscarded());
			assertFalse(checkpoint.isFullyAcknowledged());
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID1, checkpointId, new CheckpointMetrics(), taskOperatorSubtaskStates1), mock(TaskManagerLocation.class));
			...
			long checkpointIdNew = coord.getPendingCheckpoints().entrySet().iterator().next().getKey();
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID1, checkpointIdNew), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID2, checkpointIdNew), mock(TaskManagerLocation.class));
	...
	public void testMultipleConcurrentCheckpoints() {
		try {
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID2, checkpointId1), mock(TaskManagerLocation.class));
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID3, checkpointId1), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, checkpointId2), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, checkpointId1), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID2, checkpointId2), mock(TaskManagerLocation.class));
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID3, checkpointId2), mock(TaskManagerLocation.class));
	...
	public void testSuccessfulCheckpointSubsumesUnsuccessful() {
		try {
			...
			// acknowledge one of the three tasks
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID2, checkpointId1, new CheckpointMetrics(), taskOperatorSubtaskStates1_2), mock(TaskManagerLocation.class));
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID3, checkpointId2, new CheckpointMetrics(), taskOperatorSubtaskStates2_3), mock(TaskManagerLocation.class));

			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, checkpointId2, new CheckpointMetrics(), taskOperatorSubtaskStates2_1), mock(TaskManagerLocation.class));

			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, checkpointId1, new CheckpointMetrics(), taskOperatorSubtaskStates1_1), mock(TaskManagerLocation.class));

			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID2, checkpointId2, new CheckpointMetrics(), taskOperatorSubtaskStates2_2), mock(TaskManagerLocation.class));
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID3, checkpointId1, new CheckpointMetrics(), taskOperatorSubtaskStates1_3), mock(TaskManagerLocation.class));
	...
	public void testCheckpointTimeoutIsolated() {
		try {
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, checkpoint.getCheckpointId(), new CheckpointMetrics(), taskOperatorSubtaskStates1), mock(TaskManagerLocation.class));
	...
	public void testHandleMessagesForNonExistingCheckpoints() {
		try {
			...
			// wrong job id
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(new JobID(), ackAttemptID1, checkpointId), mock(TaskManagerLocation.class));

			// unknown checkpoint
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID1, 1L), mock(TaskManagerLocation.class));

			// unknown ack vertex
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, new ExecutionAttemptID(), checkpointId), mock(TaskManagerLocation.class));
	...
	public void testStateCleanupForLateOrUnknownMessages() throws Exception {
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, triggerAttemptId, checkpointId, new CheckpointMetrics(), taskOperatorSubtaskStatesTrigger), mock(TaskManagerLocation.class));
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, new ExecutionAttemptID(), checkpointId, new CheckpointMetrics(), unknownSubtaskState), mock(TaskManagerLocation.class));
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(new JobID(), new ExecutionAttemptID(), checkpointId, new CheckpointMetrics(), differentJobSubtaskState), mock(TaskManagerLocation.class));
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, triggerAttemptId, checkpointId, new CheckpointMetrics(), triggerSubtaskState), mock(TaskManagerLocation.class));
		...
		coord.receiveDeclineMessage(new DeclineCheckpoint(jobId, ackAttemptId1, checkpointId), mock(TaskManagerLocation.class));
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, ackAttemptId2, checkpointId, new CheckpointMetrics(), ackSubtaskState), mock(TaskManagerLocation.class));
		...
		// receive an acknowledge message for an unknown vertex
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, new ExecutionAttemptID(), checkpointId, new CheckpointMetrics(), unknownSubtaskState2), mock(TaskManagerLocation.class));
	...
	public void testMinTimeBetweenCheckpointsInterval() throws Exception {
		...
		try {
			...
			coord.receiveAcknowledgeMessage(ackMsg, mock(TaskManagerLocation.class));
	...
	public void testTriggerAndConfirmSimpleSavepoint() throws Exception {
		...
		coord.receiveAcknowledgeMessage(acknowledgeCheckpoint2, mock(TaskManagerLocation.class));
	...
	public void testSavepointsAreNotSubsumed() throws Exception {
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID1, checkpointId2), mock(TaskManagerLocation.class));
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID2, checkpointId2), mock(TaskManagerLocation.class));
		...
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID1, savepointId2), mock(TaskManagerLocation.class));
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID2, savepointId2), mock(TaskManagerLocation.class));
		...
		// Ack first savepoint
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID1, savepointId1), mock(TaskManagerLocation.class));
		coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, attemptID2, savepointId1), mock(TaskManagerLocation.class));
	...
	private void testMaxConcurrentAttempts(int maxConcurrentAttempts) {
		try {
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID, 1L), mock(TaskManagerLocation.class));
	...
	public void testMaxConcurrentAttempsWithSubsumption() {
		try {
			...
			// now, once we acknowledge one checkpoint, it should trigger the next one
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, ackAttemptID, 2L), mock(TaskManagerLocation.class));
	...
	public void testConcurrentSavepoints() throws Exception {
		...
		for (int i = 0; i < numSavepoints; i++, checkpointId--) {
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jobId, attemptID1, checkpointId), mock(TaskManagerLocation.class));
		}
	...
	public void testRestoreLatestCheckpointedState() throws Exception {
		...
		for (int index = 0; index < jobVertex1.getParallelism(); index++) {
			...
			coord.receiveAcknowledgeMessage(acknowledgeCheckpoint, mock(TaskManagerLocation.class));
		}
	...
	private void testRestoreLatestCheckpointIsPreferSavepoint(boolean isPreferCheckpoint) {
		try {
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, statefulExec1.getAttemptId(), checkpointId, new CheckpointMetrics(), subtaskStatesForCheckpoint), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, statelessExec1.getAttemptId(), checkpointId), mock(TaskManagerLocation.class));
			...
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, statefulExec1.getAttemptId(), checkpointId, new CheckpointMetrics(), subtaskStatesForSavepoint), mock(TaskManagerLocation.class));
			coord.receiveAcknowledgeMessage(new AcknowledgeCheckpoint(jid, statelessExec1.getAttemptId(), checkpointId), mock(TaskManagerLocation.class));
