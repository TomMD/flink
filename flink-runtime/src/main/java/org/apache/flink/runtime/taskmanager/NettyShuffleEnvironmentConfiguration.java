...
public class NettyShuffleEnvironmentConfiguration {
	...
	public boolean isReleaseBlockingPartitionsOnConsumption() {
	...
	public static NettyShuffleEnvironmentConfiguration fromConfiguration(
		...
		boolean isReleasingBlockingPartitionsOnConsumptions = configuration.getBoolean(NettyShuffleEnvironmentOptions.RELEASE_BLOCKING_PARTITIONS_ON_CONSUMPTION);
		...
		return new NettyShuffleEnvironmentConfiguration(
			...
			isReleasingBlockingPartitionsOnConsumptions,
			nettyConfig);
	}
