  ...
  override def onMatch(call: RelOptRuleCall): Unit = {
    ...
    builder
        ...
        .aggregate(
          ...
          builder.sum(false, "sum_val", builder.field("vcol")))
        .filter(builder.call(
          GREATER_THAN,
          builder.field("sum_val"),
          builder.literal(0)))
        .project(Seq(builder.field("sum_val")) ++ builder.fields(fields))
